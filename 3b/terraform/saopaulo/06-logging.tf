# CloudWatch Log Group for Flask application logs from EC2 — used by watchtower logging
...
# SNS Topic for database incident alerts — connects to CloudWatch alarms and email subscriptions
...
# THE ALIAS RECORD: daequanbritt.com (Apex)
# REMOVED - São Paulo uses Tokyo's CloudFront as the global entry point
# Tokyo's CloudFront already has this alias
