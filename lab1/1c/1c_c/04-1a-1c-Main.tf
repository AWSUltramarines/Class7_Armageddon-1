...
data "aws_secretsmanager_secret" "helga_db_secret01" {
  name = "helga/rds/mysqlv2"  # or whatever the name is
}

data "aws_secretsmanager_secret_version" "helga_db_secret_version01" {
  secret_id = data.aws_secretsmanager_secret.helga_db_secret01.id
}
