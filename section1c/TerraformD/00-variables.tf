...
# Explanation: Toggle for ALB access logging to S3 - essential for incident response and compliance audits.
...
# Explanation: S3 prefix organizes logs by type - keeps flight recorder data separate from cargo manifests.
