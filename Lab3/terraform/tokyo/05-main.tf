...
# Private EC2 instance running the Flask web application — connects to RDS via Secrets Manager
...
# RDS MySQL instance — the ONLY database, located exclusively in Tokyo for APPI compliance
