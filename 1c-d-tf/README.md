...
* **Audit Logging**: Automated delivery of ALB Access Logs to a secure S3 bucket for forensic analysis.
...
| **WAFv2** | Web Firewall | <br>**Edge Defense**: Protects the entry point from SQLi and XSS attacks using AWS Managed Core Rules. |
...
| **CloudWatch** | Monitoring | <br>**Observability**: Real-time dashboards and 5xx error alarms linked to SNS email notifications. |
