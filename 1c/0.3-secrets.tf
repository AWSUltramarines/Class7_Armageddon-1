...
#
# Lab 1c: Preserved from Lab 1b (dual secret storage)
# - Secrets Manager: username, password (and full connection info)
...
# -----------------------------------------------------------------------------
# SSM Parameter Store for operational metadata
# -----------------------------------------------------------------------------
