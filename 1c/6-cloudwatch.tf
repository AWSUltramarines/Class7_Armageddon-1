# cloudwatch.tf - CloudWatch Logs, Metrics, and Alarms
#
# Lab 1c: Preserved from Lab 1b (unchanged)
# - CloudWatch Logs: Centralized application logging (via VPC endpoint)
