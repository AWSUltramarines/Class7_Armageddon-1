...
#LAB 1B CLOUDWATCH ALARM

dnf install -y python3-pip aws-cli amazon-cloudwatch-agent
...
cat << 'PY_SCRIPT' > /home/ec2-user/db_monitor.py
import boto3
import json
import time
import pymysql
...
logging.basicConfig(filename='/home/ec2-user/app.log', level=logging.INFO, format='%(asctime)s %(message)s')
...
nohup python3 /home/ec2-user/db_monitor.py &