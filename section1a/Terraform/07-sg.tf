...
#### for webserver ####
resource "aws_security_group" "web-lab-app-sg" {
    name = "web-lab-app-sg"
...
resource "aws_vpc_security_group_ingress_rule" "web_server_http" {
    security_group_id = aws_security_group.web-lab-app-sg.id
...
resource "aws_security_group" "rds-ec2-sg" {
    ...
    vpc_id      = aws_vpc.armageddon-world-vpc.id # Reference your VPC ID here
...
resource "aws_vpc_security_group_ingress_rule" "rds-ec2-ingress" {
    ...
    referenced_security_group_id = aws_security_group.web-lab-app-sg.id
